...
class inode_state {
   ...
   public:
      ...
      void setCwd(inode_ptr newDir){cwd = newDir;}
      void setPrompt(const string& newPrompt) {prompt_ = newPrompt;}
      void setCurrentDir(string newDir) {currentDir = newDir;}
...
class base_file {
   ...
   public:
      ...
      virtual void addEntry(const string& filename, inode_ptr pointer);
      virtual map<string,inode_ptr> getDirents();
      virtual bool isFile() {return is_file;}
      virtual void setFile(bool change) {is_file = change;}
};

// class plain_file -
// Used to hold data.
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void addEntry(const string& filename, inode_ptr pointer) override;
